        ...
        <svg class="fill-current text-gray-600 hover:text-gray-800" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full relative" id="menu">
                ...
                <a href="#" class="group lg:ml-4 flex items-center justify-start lg:mb-0 mb-4 pointer-cursor border-l border-gray-300 pl-6" id="userdropdown">
                    ...
                    <img class="rounded-full w-10 h-10 border-2 border-gray-300 group-hover:border-indigo-400 ignore-body-click" src="{{ auth()->user()->photo }}" alt="avatar">
                </a>
...
<div class="container mx-auto max-w-3xl mt-8">    
    <div class="bg-red-500 text-white p-4 rounded-lg">
        <p class="font-bold">Please correct your submission</p>

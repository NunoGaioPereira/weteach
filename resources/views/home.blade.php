...
<div class="h-24 w-full relative z-50">
        ...
        <div class="container max-w-6xl mx-auto h-full flex justify-center sm:justify-between items-center px-8 xl:px-0">
            ...
            <div id="navAuth" class="absolute sm:relative w-full sm:w-auto bg-white sm:bg-transparent border-b sm:border-none border-gray-200 mt-48 sm:mt-0 flex-col sm:flex-row pb-8 sm:p-0 justify-center items-center sm:items-end flex hidden sm:flex sm:justify-between ">
                <a href="/" class="px-5 py-2 text-sm text-pink-500 lg:text-white font-bold mr-0 sm:mr-3 relative z-40">Home</a>
                <a href="#_" class="px-5 py-2 text-sm text-pink-500 lg:text-white font-bold mr-0 sm:mr-3 relative z-40">Features</a>
                <a href="#_" class="px-5 py-2 text-sm text-pink-500 lg:text-white font-bold mr-0 sm:mr-3 relative z-40">Pricing</a>
                <a href="#_" class="px-5 py-2 text-sm text-pink-500 lg:text-white font-bold mr-0 sm:mr-3 relative z-40">FAQ</a>
                <a href="{{ route('login') }}" class="px-5 py-3 rounded fold-bold text-sm transition-all duration-300 leading-none bg-indigo-700 lg:bg-white text-white lg:text-indigo-700 w-auto sm:w-full h-full inline-block font-bold relative shadow-md lg:shadow-none hover:shadow-xl duration-100 transition z-40">Login</a>
    ...
    <div class="w-full lg:h-screen w-screen justify-center items-center relative  overflow-x-hidden">
        ...
        <div class="container max-w-6xl mx-auto h-full flex flex-col lg:flex-row justify-between items-center -mt-32 xl:px-0 px-8">
            ...
            <div class="flex flex-col items-center lg:items-start w-full max-w-xl lg:w-1/2 pt-48 lg:pt-20 xl:pt-40 text-center lg:text-left z-30">
                ...
                <a href="{{ route('login') }}" class="mt-0 sm:mt-1 px-5 py-3 rounded fold-bold text-base bg-indigo-600 shadow-xl text-white border-t border-gray-200 w-auto font-bold relative self-start inline-block lg:mx-0 mx-auto">Login</a>

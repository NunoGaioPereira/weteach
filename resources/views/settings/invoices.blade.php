                    ...
                    <table class="w-full">
                        ...
                        @foreach($invoices as $invoice)
                            <tr>
                                ...
                                <td class="border-b border-gray-200 py-3 text-gray-700"><a class="underline text-indigo-600 font-bold" href="{{ route('invoices.download', $invoice->id) }}">Download</a></td>
                            </tr>
                        @endforeach
                    </table>
                </div>
